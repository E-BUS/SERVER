package EBus.EBusback.global.service;

import EBus.EBusback.global.exception.CustomException;
...
public class S3Uploader {
    ...
    public String upload(MultipartFile multipartFile, String dirName) throws IOException {
        File uploadFile = convert(multipartFile)
                .orElseThrow(() -> new CustomException(ErrorCode.CONVERT_MULTIPARTFILE_ERROR));
